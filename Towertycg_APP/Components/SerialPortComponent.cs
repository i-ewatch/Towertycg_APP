...
namespace Towertycg_APP.Components
{
    ...
    {
        public SerialPortComponent(GatewaySetting gatewaySetting, List<DeviceSetting> deviceSettings, List<NotifySetting> notifySettings, GroupSetting groupSetting)
        {
            InitializeComponent();
