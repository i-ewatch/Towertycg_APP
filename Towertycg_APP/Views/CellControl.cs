    ...
    public partial class CellControl : Field4Control
    {
        ...
        public override void TextChange()
        {
            if (CellDevice != null)
            {
                ...
                lbl_InAbsoluteHumidity.Text = $"{CellDevice.InAbsoluteHumidity.ToString("0.####")} kg/m\xb3";
                ...
                lbl_OutAbsoluteHumidity.Text = $"{CellDevice.OutAbsoluteHumidity.ToString("0.####")} kg/m\xb3";
